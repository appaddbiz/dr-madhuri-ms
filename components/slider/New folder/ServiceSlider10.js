...
export default function ServiceSlider10() {
  return (
    <>
      <Swiper
        {...swiperOptions}
        className="theme_carousel owl-theme service10-carousel"
      >
        {/*Start Service Block Ten*/}
        <SwiperSlide className="service-block-ten text-center">
          <div
            className="service-block-ten_bg"
            style={{
              backgroundImage: "url(assets/images-3/choose-block-nine-bg.jpg)",
            }}
          />
          <div className="icon">
          ...
          <div className="button">
            <Link href="#" className="theme-btn btn-style-nine">
