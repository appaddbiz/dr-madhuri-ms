...
export default function TeamSlider8() {
  return (
    <>
      <Swiper
        {...swiperOptions}
        className="theme_carousel owl-theme team8-carousel"
      >
        {/*Team Block Eight*/}
            ...
            <div className="overlay-content">
              <div className="inner">
                ...
                <div className="bottom-content">
                  ...
                  <div className="text">
                    <p>
                      <Link href="tel:+18005554400">+44 555 66 789</Link>
                    </p>
                    <p>
                      <Link href="mailto:support@envolvepsyco.com">
                        alphonso@envolve.com
                      </Link>
                    </p>
                  </div>
                </div>
