        ...
        <SwiperSlide className="service-block-two">
          <div className="inner-box">
            ...
            <div
              className="overlay"
              style={{
                backgroundImage: "url(assets/images/resource/image-17.jpg)",
              }}
            >
              <div className="text">
                In a free hour when our <br />
                power choices when proven <br /> best distinguish.{" "}
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="service-block-two">
          <div className="inner-box">
            ...
            <div
              className="overlay"
              style={{
                backgroundImage: "url(assets/images/resource/image-19.jpg)",
              }}
            >
              <div className="text">
                In a free hour when our <br />
        ...
        <SwiperSlide className="service-block-two">
          <div className="inner-box">
            ...
            <div
              className="overlay"
              style={{
                backgroundImage: "url(assets/images/resource/image-30.jpg)",
              }}
            >
              <div className="text">
                In a free hour when our <br />
