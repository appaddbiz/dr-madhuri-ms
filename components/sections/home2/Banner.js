                ...
                <div className="col-xl-12">
                  <div className="main-slider-two__content">
                    <h2 className="main-slider-two__title">
                      We Turn Ideas <br /> Into <span>Digital</span>
                      <br />
                      Reality
                    </h2>
                    <p className="main-slider-two__text">
                      We have 12+ year of experience for providing
                      <br />
                    ...
                    <div className="main-slider-two__call">
                      <div className="main-slider-two__call-icon">
                        <img
                          src="assets/images/icon/main-menu-two-comment-icon.png"
                          alt=""
                        />
                      </div>
                      <div className="main-slider-two__call-number">
                        <p>Call any time</p>
                        <h5>
                          <a href="tel:12987458741">+12-987458741</Link>
                        </h5>
                      </div>
                    </div>
                    <div className="main-slider-two__arrow">
                      <img
                        src="assets/images/shapes/main-slider-two-arrow.png"
                        alt=""
