              ...
              <div className="service-two__single">
                <div className="service-two__content-inner">
                  <div className="service-two__content">
                    ...
                    <h3>
                      <Link href="digital-marketing">Investment Planning</Link>
                    </h3>
                  </div>
                ...
                <div className="service-two__img-box">
                  <div
                    className="service-two__img-box-bg"
                    style={{
                      backgroundImage:
                        " url(assets/images/shapes/service-two-img-box-bg.png)",
                    }}
                  ></div>
                  <div
                    className="service-two__img-box-bg-2"
                    style={{
                      backgroundImage:
                        " url(assets/images/shapes/service-two-img-box-hover-bg.png)",
                    }}
                  ></div>
              ...
              <div className="service-two__single">
                <div className="service-two__content-inner">
                  <div className="service-two__content">
                    ...
                    <h3>
                      <Link href="ui-ux-designing">High Quality Services</Link>
                    </h3>
                  </div>
                  <p className="service-two__text">
                    Design professionals,there's a bit of controversy
