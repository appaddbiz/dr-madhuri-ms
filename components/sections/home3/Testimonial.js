  ...
  return (
    <>
      ...
      <section className="testimonial-three">
        ...
        <div
          className="testimonial-three__img-1 wow fadeInRight"
          data-wow-delay="100ms"
        >
          <img
            src="assets/images/testimonial/testimonial-three-img-1.png"
            alt=""
          />
            ...
            <div className="col-xl-5 col-lg-5">
              <div className="testimonial-three__left">
                ...
                <p className="testimonial-three__text">
                  There are many varins of passages of Lorem Ipsum available,
                  But majority have suffered There are many varins of passages
                </p>
                <div className="testimonial-three__btn-box">
                  <Link
                    href="testimonials"
                    className="testimonial-three__btn thm-btn"
                  >
                    View More
                  </Link>
                </div>
                      ...
                      <SwiperSlide>
                        <div className="swiper-slide">
                          <div className="testimonial-three__single">
                            ...
                            <p className="testimonial-three__single-text">
                              “ This is due their excellent service, competitive
                              pricing and customer support. It's throughly
                              refresing to get such a personal touch. Duis aute
                              lorem ipsum is simply free text irure dolor in
