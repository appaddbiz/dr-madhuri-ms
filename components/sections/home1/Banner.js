                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="main-slider__content">
                                        <h2 className="main-slider__title">Build Effective <br/> <span>Marketing</span> <br/>
                                            Strategy</h2>
                                        <p className="main-slider__text">We have 12+ year of experience for providing <br/>
                                            consulting services solutions.</p>
                                        <div className="main-slider__btn-box">
                                            <Link href="contact" className="main-slider__btn thm-btn">Get Free Quote</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
