  ...
  return (
    <>
      <Layout
        headerStyle={1}
        footerStyle={1}
        breadcrumbTitle={pageData ? pageData.title : "Service Details"}
      >
              ...
              <div className="col-xl-8 col-lg-7">
                <div className="service-details__left">
                  ...
                  {pageData?.sections?.map((section, idx) => (
                    <div
                      key={idx}
                      className="service-details__img-and-point-box"
                    >
                      {section?.image && (
              ...
              <div className="col-xl-4 col-lg-5">
                <div className="sidebar">
                  ...
                  <div className="sidebar__single service-details__need-help">
                    ...
                    >
                      Schedule your consultation with Dr. Madhuri M S today.
                      Call us to book an appointment at your convenience.
                    </p>
