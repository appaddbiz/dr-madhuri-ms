    ...
    <>
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Testimonials">
        ...
        <section className="testimonial-two testimonial-four">
          <div
            className="testimonial-two__right-img wow slideInRight"
            data-wow-delay="100ms"
            data-wow-duration="2500ms"
          >
            <img
              src="assets/images/testimonial/testimonial-two-right-img.png"
              alt=""
            />
          </div>
            ...
            <div className="row">
                          ...
                          <div className="swiper-slide">
                            <div className="testimonial-two__single">
                              ...
                              <p className="testimonial-two__text">
                                ...
                                lipsum is simply free text by injected humou or
              ...
              <div className="col-xl-6">
                <div className="testimonial-two__right">
                  <form
                    className="contact-form-validated testimonial-two__form"
                    method="post"
                  >
                    <div className="row">
                      <div className="col-xl-6">
                      ...
                      <div className="col-xl-6">
                        <div className="testimonial-two__btn-box">
                          <button
                            type="submit"
                            className="thm-btn testimonial-two__btn"
                          >
                            See More<span className="fas fa-angle-right"></span>
                          </button>
                        </div>
                      </div>
                    </div>
