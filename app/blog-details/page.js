                ...
                <div className="blog-details__left">
                  ...
                  <div className="blog-details__content">
                    ...
                    <h3 className="blog-details__title">
                      Basic rules of running best Marketing Services
                    </h3>
                    <p className="blog-details__text-1">
                      There’re many variation of passages of Lorem Ipsum
                      available, but the majority have suffer alteration in some
                      form, by injected humour, or randomised word which don't
                      look even slightly believable. If you’re going to use a
                  ...
                  <div className="blog-details__comment-box">
                    <h3 className="blog-details__comment-title-top">
                      2 Comments
                    </h3>
                ...
                <div className="sidebar">
                    ...
                    <ul className="sidebar__post-list list-unstyled">
                      ...
                      <li>
                        ...
                        <div className="sidebar__post-content">
                          <h3>
                            <Link href="blog-details">
                              We Build and Active Brands Insight
                            </Link>
                          </h3>
                        </div>
                      </li>
                  ...
                  <div className="sidebar__single sidebar__category">
                    ...
                    <ul className="sidebar__category-list list-unstyled">
                      <li>
                        <Link href="blog-details">
                          Business<span className="fas fa-angle-right"></span>
                        </Link>
                      </li>
                      <li>
                        <Link href="blog-details">
                  ...
                  <div className="sidebar__single sidebar__comments">
                    ...
                    <ul className="sidebar__comments-list list-unstyled">
                      ...
                      <li>
                        ...
                        <p>
                          Robert Jonson on Template: <span>Comments</span>
                        </p>
                      </li>
                      <li>
                        <div className="icon">
                      ...
                      <li>
                        ...
                        <p>
                          Jessica Brown on Template: <span>Comments</span>
                        </p>
                      </li>
                    </ul>
                  </div>
