  ...
  return (
    <>
      <Layout
        headerStyle={1}
        footerStyle={1}
        breadcrumbTitle="Seo Content Writting"
      >
                ...
                <div className="service-details__left">
                  ...
                  <div className="service-details__img-and-point-box">
                    <div className="service-details__point-img">
                      <img
                        src="assets/images/services/service-details-point-img.jpg"
                        alt=""
                      />
                    </div>
                ...
                <div className="sidebar">
                  ...
                  <div className="sidebar__single service-details__need-help">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          " url(assets/images/services/service-details-need-help-bg.jpg)",
                      }}
                    ></div>
                    ...
                    <p className="service-details__need-help-text">
                      ...
                      corporate office & we will connect you with a team member
                      who can help.
                    </p>
