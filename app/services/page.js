      ...
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Our services">
        ...
        <section className="service-three">
          <div
            ...
            style={{
              backgroundImage:
                " url(assets/images/backgrounds/service-three-bg.jpg)",
            }}
          ></div>
          <div
            className="service-three__img wow slideInLeft"
            ...
            <div className="row">
              ...
              >
                <div className="service-three__left">
                  ...
                  <p className="service-three__text">
                    ...
                    <br /> service while offering our employees the best
                    training.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="service-three__single">
                  ...
                  <div className="service-three__shape-1">
                    <img
                      src="assets/images/shapes/service-three-shape-1.png"
                      alt=""
                    />
                  </div>
                  ...
                  <h3 className="service-three__title">
              ...
              >
                <div className="service-three__single">
                  ...
                  <h3 className="service-three__title">
                    <Link href="seo-content-writting">
                      SEO & Content
                      <br /> Writing
                    </Link>
                  </h3>
                    ...
                    <div className="blog-two__title-box">
                      ...
                      <h3 className="blog-two__title">
                        <Link href="blog-details">
                          What is the 2024 trend for Graphic Design ?
                        </Link>
                      </h3>
                      <p className="blog-two__text">
                        Business is the activity of making one's livcing or
