              ...
              <div className="col-xl-8 col-lg-7">
                <div className="project-details__left">
                  ...
                  <p className="project-details__text-1">
                    ...
                    culpa qui officia deserunt mollanim id estise laborum. Sed
                    ut perspiciatis unde omnis iste natus error voluptatem
                    accusantium doloremque suppost laudantium, totam rem aperiam
                  </p>
                  <p className="project-details__text-2">
                    Ut enim ad minim veniam, quis nostrud exercitation ullamco
                    laboris nisi commodon consequat. Duis
                    <br />
                  ...
                  <div className="project-details__content-and-img">
                    ...
                    <div className="project-details__content-img">
                      <img
                        src="assets/images/project/project-details-content-img-1.jpg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div className="col-xl-4 col-lg-5">
                <div className="project-details__right">
                  <div className="project-details__project-information">
                    <h3 className="project-details__project-information-title">
                      Portfolio Details
                    </h3>
