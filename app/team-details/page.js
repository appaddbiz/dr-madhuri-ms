                ...
                <div className="col-xl-5 col-lg-5">
                  <div className="team-details__top-left">
                    <div className="team-details__top-img">
                      <img
                        src="assets/images/team/team-details-top-img-1.jpg"
                        alt=""
                      />
                ...
                <div className="col-xl-7 col-lg-7">
                  <div className="team-details__right">
                    ...
                    <p className="team-details__text">
                      ...
                      irure dolor reprehenderit in voluptate velits esse cillum
                    ...
                    <div className="team-details__call-box">
                      <ul className="team-details__call-list list-unstyled">
                        <li>
                          <p>
                            Phone :{" "}
                            <Link href="tel:000325123">000-325-123</Link>
                          </p>
                        </li>
                        <li>
                          <p>
                      ...
                      <ul className="team-details__call-list team-details__call-list-2 list-unstyled">
                        <li>
                          <p>
                            Website : <Link href="#">Webexample.com</Link>
                          </p>
                        </li>
                        <li>
                          <p>
              ...
              <div className="row">
                <div className="col-xl-6 col-lg-6">
                  <div className="team-details__bottom-left">
                    ...
                    <p className="team-details__bottom-left-text">
                      Penatibus pulvinar hac lacinia interdum fermentum tortor
                      aite montes aecenas pretiun dignissim facilisi top level
                      vehicula.
                    </p>
                      ...
                      <ul className="team-details__bottom-left-points-list list-unstyled">
                        <li>
                          ...
                          <div className="team-details__bottom-points-content">
                            ...
                            <p>
                              Congue lacinia aenean venenatis arcu rutrum vitae
                              sus
                              <br /> pena tibus lectus dapibus integer
                              habitasses
                            </p>
                          </div>
                        </li>
                ...
                <div className="col-xl-6 col-lg-6">
                  <div className="team-details__bottom-img">
                    <img
                      src="assets/images/team/team-details-bottom-img-1.jpg"
                      alt=""
                    />
                  </div>
                </div>
