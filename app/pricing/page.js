              ...
              >
                <div className="pricing-one__single">
                  <div className="pricing-one__title-box">
                    <div
                      className="pricing-one__title-box-bg"
                      style={{
                        backgroundImage:
                          " url(assets/images/backgrounds/pricing-one-title-box-bg.jpg)",
                      }}
                    ></div>
                    <h3 className="pricing-one__title">Basic Plan</h3>
                    <h4 className="pricing-one__price">
