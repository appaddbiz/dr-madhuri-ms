  ...
  return (
    <>
      <Layout
        headerStyle={1}
        footerStyle={1}
        breadcrumbTitle="farming products"
      >
                          ...
                          <div className="accrodion-content">
                            <div className="inner">
                              <p>
                                ...
                                type and scrambled it to make a type spec book.
                          ...
                          <div className="accrodion-content">
                            <div className="inner">
                              <p>
                                ...
                                distribution of letters Residential Cleaning{" "}
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <div className="sidebar">
                  ...
                  <div className="sidebar__single sidebar__services">
                    <ul className="sidebar__services-list">
                      ...
                      <li>
                        <Link href="delivery-services">
                          Delivery services{" "}
                          <span className="icon-arrow-right"></span>
                        </Link>
                      </li>
                      <li>
                        <Link href="farming-products">
                          Farming products{" "}
                          <span className="icon-arrow-right"></span>
                        </Link>
                      </li>
                  ...
                  {/* Start Sidebar Single*/}
                  <div
                    className="sidebar__single sidebar__contact"
                    style={{
                      backgroundImage:
                        " url(assets/images/sidebar/sidebar-img1.jpg)",
                    }}
                  >
                    <div className="sidebar__contact-inner text-center">
                      ...
                      <div className="text-box">
                        ...
                        <h3>
                          <Link href="923076806860">+ 92 (307)68 - 06860</Link>
                        </h3>
                      </div>
                    </div>
                  </div>
